...
public class Entrada extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtIdEntrada = new javax.swing.JLabel();
        ...
        jPanel1.add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 200, 30));
        ...
        jPanel1.add(txtCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 257, 200, 30));
        ...
        jPanel1.add(txtCost, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 344, 200, 30));
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 136, 190, 28));
        ...
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 223, 190, 28));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 310, 190, 28));

        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Id Entrada");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 0, 61, 30));

        txtIdEntrada.setForeground(new java.awt.Color(255, 255, 255));
        txtIdEntrada.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtIdEntrada.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        jPanel1.add(txtIdEntrada, new org.netbeans.lib.awtextra.AbsoluteConstraints(26, 28, 151, 25));
        ...
        jPanel1.add(btnIngresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 392, -1, 30));

        jPanel2.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 200, 430));
        ...
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 80, 200, 30));
        ...
        jPanel2.add(txtFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 120, 200, 25));
        ...
        btnCrear.setText("Presiona para crear entrada");
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        if(txtIdEntrada.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Debes crear la entrada");
        }else{
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        try{
            ...
            JOptionPane.showMessageDialog(null, "no has seleccionado una entrada");
        }   
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        entrada.setFecha(((JTextField)txtFecha.getDateEditor().getUiComponent()).getText());
        entrada.setTotal(Double.parseDouble(txtTotal.getText()));
        entrada.setIdStatus("2");
        dao.Guardar(entrada, "entrada");
        try{
            ...
            for (int i = 0;filas>i; i++) {
                ...
                Entradap s=new Entradap();
                    s.setId_rel( txtIdEntrada.getText() );
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        txtIdEntrada.setText ( dao.car( "entrada" ));
    ...
    private void txtCostMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtCostMousePressed
        if( txtCost.getText().equals( "5000" ) ){
            txtCost.setText( "" );
    ...
    private javax.swing.JLabel txtIdEntrada;
